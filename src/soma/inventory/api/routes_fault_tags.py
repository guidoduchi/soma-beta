...
FAULT_TAG_ROUTE_SPECS: tuple[InventoryRouteSpec, ...] = (
    ...
    route_spec("POST", "/api/v1/inventory/bulk/preview", "query", "PreviewInventoryBulkAction", "InventoryBulkPreviewQueryV1", "InventoryBulkPreviewV1", 200, 262144, "LLD12_BROWSER_QUERY_V1", ["BULK_INCOMPATIBLE","DEPENDENCY_INDETERMINATE"]),
    route_spec("POST", "/api/v1/inventory/bulk/accept", "command", "AcceptInventoryBulkAction", "AcceptInventoryBulkActionRequestV1", "InventoryMutationResultV1", 200, 262144, "LLD12_BROWSER_MUTATION_V1", ["INV_STALE","BULK_INCOMPATIBLE","WAREHOUSE_FINAL_CONFIRMATION_REQUIRED","DEPENDENCY_INDETERMINATE","IDEMPOTENCY_CONFLICT"]),
