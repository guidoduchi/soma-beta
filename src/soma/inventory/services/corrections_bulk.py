    ...
    def hard_delete_untouched_inventory_draft(
        ...
        *,
        ...
        if target_kind == "fault_tag":
            return self.hard_delete_untouched_fault_tag(
                command_id=command_id,
                fault_tag_id=target_id,
        ...
        if target_kind not in {
            ...
            raise ValidationError("Inventory hard-delete target kind is invalid")
        identity = require_uuid4(target_id)
        ...
        handler = preview_handlers[target_kind]
        envelope = CommandEnvelope(
            command_id=command_id,
        ...
        def prepare(uow: UnitOfWork) -> PreparedMutation:
            ...
            def apply(inner: UnitOfWork):
                require_clear(inner.connection)
